...
function getCoverFromChartItem(chartItem, $) {
  ...
  try {
    ...
    if (image) {
      ...
      if (
        imgPath === "/assets/1551380838/images/charts/bb-placeholder-new.jpg"
      ) {
...
function getPositionLastWeekFromChartItem(chartItem, $) {
  ...
  try {
    positionLastWeek =
      $(".chart-element__meta.text--last", chartItem).text() ||
...
function getPeakPositionFromChartItem(chartItem, $) {
  ...
  try {
    peakPosition =
      $(".chart-element__meta.text--peak", chartItem).text() ||
...
function getWeeksOnChartFromChartItem(chartItem, $) {
  ...
  try {
    weeksOnChart =
      $(".chart-element__meta.text--week", chartItem).text() ||
